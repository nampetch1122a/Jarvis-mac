...
OUTPUT_DIR = os.path.expanduser("~/jarvis-mac/outputs")
KNOWLEDGE_DIR = os.path.expanduser("~/jarvis-mac/knowledge")
...
def upload():
    ...
    upload_dir = os.path.expanduser("~/jarvis-mac/uploads")
...
ตอบภาษาไทย ประโยคธรรมชาติ"""
    ...
    with open(os.path.expanduser("~/jarvis-mac/jarvis_state.json"), "w") as f:
        json.dump({"status": "responded", "text": answer, "file": file.filename}, f, ensure_ascii=False)
